            ...
            <div class="col-md-6">
                <form action="../Controller/ControllerDoctores.php" method="post">
                    <div class="mb-3">
                        ...
                        <input type="email" autocomplete="off" class="form-control" name="emailogindoctor" id="emailogindoctor" aria-describedby="emailHelp" required>
                    </div>
                    <div class="mb-3">
                        <label for="password" class="form-label">Contraseña</label>
                        <input type="password" autocomplete="off" class="form-control" name="contrasenalogindoctor" required>
                    </div>
