        ...
        for (let i = 0; i < 6; i++) {
          ...
          for (let j = 0; j < 7; j++) {
            ...
            /*Si el día actual pertenece al mes actual, se agrega una celda con el número del día*/
              ...
              if(fechaCita.dia ==dayOfMonth && fechaCita.mes == currentMonth &&
               fechaCita.annio == currentDate.year()){
                celda = `<td class="text-center bg-warning" 
                onmouseout="this.style.backgroundColor='#5c84a7'; this.style.color='inherit';" onmouseover="this.style.backgroundColor='#ebb206.'; this.style.color='#fff';" id="celda${celdaBoton}" p-0 m-0 cell"><button type="button" data-bs-toggle="modal" id="celdaBoton" data-bs-target="#ModalEleccion"  class="btn btn-transparent fw-bold btn-hover w-100 h-100" onclick="subirVariableSesion(${dayOfMonth},${currentMonth},${currentDate.year()})">${dayOfMonth}</button></td>`;
              }
            });
