      ...
      foreach ($citas as $cita) : 
        ...
        <ul class="mt-3 bg-grisclarito p-3" id="estiloAgenda">
          <li class="position-relative text-center" style="width: 450px; margin: 0 auto;">
            ...
            <a href="#" class="btn btn-primary btn-sm position-absolute top-0 end-0 translate-middle-y" data-bs-toggle="modal" data-citanombre=<?php echo $cita->getNombrePaciente() ?> data-horafin=<?php echo $cita->getHoraFinal() ?> data-detalles="<?php echo $cita->getDetalles() ?>" data-horaprincipio=<?php echo $cita->getHoraInicio() ?> data-bs-target="#modalDetalleCita"><i class="fas fa-info-circle"></i></a>
          </li>
        </ul>
      <?php endforeach; ?>
