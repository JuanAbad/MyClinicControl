        ...
        <ul class="mt-3 bg-grisclarito p-3" id="estiloAgenda">
          <li class="position-relative text-center" style="width: 450px; margin: 0 auto;">
            <div>
              ...
              <a href="" class="text-primary text-decoration-none" data-bs-toggle="modal" data-bs-target="#modalDetallePacientes"><?php echo $cita->getNombrePaciente() ?></a>
              <br><br><br>
            ...
            <a href="#" class="btn btn-primary btn-sm position-absolute top-0 end-0 translate-middle-y"><i class="fas fa-info-circle"></i></a>
          </li>
        </ul>
      <?php endforeach; ?>
