...
?>
    ...
    <div class="table-responsive rounded px-3" style="overflow-y: scroll; max-height:505px;">
        <table class="table rounded table table-striped table-borderless table-primary align-middle shadow table-scrollable">
            ...
            <tbody class="table-group-divider">
                ...
                foreach ($pacientes as $paciente) : ?>
                    <tr class="table-primary">
                        ...
                        <td class="text-center"><?php $patologia = $paciente->getPatologia();
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <button class="btn btn-primary me-1 btn-editar" name="btn-editar"
                                 data-id='<?php echo $paciente->getDni() ?>'>
                                ...
                                $i++;
                                ?>
                                <button type="button" class="btn btn-danger btn-eliminar" data-bs-toggle="modal" data-dnipaciente='<?php echo $paciente->getDni() ?>' data-bs-target="#confirmDeleteModal<?php echo $i ?>">
                    ...
                    <div class="modal fade" id="confirmDeleteModal<?php echo $i ?>" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form action="../Controller/ControllerPacientes.php" method="post">
                                    <input type="hidden" name="dnipaciente" id="dnipaciente" value=<?php echo $paciente->getDni() ?>>
